...
1. In your WIP folder open your file `index.html` which you created which had Welcome in different languages.
...
1. Notice how VS Code will try to complete the path for you. You want this to be the complete line:
    ```html
